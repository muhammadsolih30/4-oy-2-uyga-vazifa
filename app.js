...
console.log("1-masala:", power(3, 5)); // => 243
...
console.log("2-masala:", mean(12, 48)); // => [30, 24]
...
console.log("3-masala:", sign(10)); // => 1
...
console.log("4-masala:", numberOfRoots(1, -6, 9)); // => 1
...
console.log("6-masala:", sumRange(8, 10)); // => 27
...
console.log("7-masala 1:", calc(10, 15, '*')); // => 150
console.log("7-masala 2:", calc(7, 8, '+'));   // => 15
...
console.log("8-masala:", isEven(10)); // => true
...
console.log("9-masala:", sortABC(10, 5, 8)); // => [5, 8, 10]
...
console.log("10-masala:", isPowerN(243, 3)); // => true
...
console.log("11-masala:", isPrime(7)); // => true
...
console.log("12-masala:", numberOfPrime(10)); // => 4
...
console.log("13-masala 1:", digitNth(105782, 5)); // => 8
console.log("13-masala 2:", digitNth(1057, 5));   // => -1
...
console.log("14-masala:", inverseNumber(56814)); // => 41865
...
console.log("15-masala:", isPalindrom(1678761)); // => true
...
console.log("16-masala:", factorial(5)); // => 120
...
console.log("17-masala:", getSum3(15)); // => 45
...
console.log("18-masala:", sumOddEven(10)); // => [30, 25]
...
console.log("19-masala:", invertTime(0, 6, 40)); // => 400
...
console.log("20-masala:", decTime(0, 6, 40)); // => 00:06:39
...
console.log("21-masala:", isLeapYear(2020)); // => true
...
console.log("22-masala:", monthDays(2, 2020)); // => 29
...
console.log("23-masala:", prevDate(10, 3, 2022)); // => 09.03.2022
...
console.log("24-masala:", nextDate(10, 3, 2022)); // => 11.03.2022
...
console.log("25-masala:", getDividersNumberAndSum(12)); // => [6, 28]
